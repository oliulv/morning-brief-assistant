...
export const getNotionTasksTool = {
  definition: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        today_start_iso: {
          type: "string",
          description: "Start of today in ISO 8601 format",
        },
        today_end_iso: {
          type: "string",
          description: "End of today in ISO 8601 format",
        },
        days_ahead: {
          type: "number",
          description: "Number of days ahead to fetch upcoming tasks",
        },
        tz: {
          type: "string",
      ...
      required: ["api_key", "database_id", "today_start_iso", "today_end_iso"],
    },
  },
